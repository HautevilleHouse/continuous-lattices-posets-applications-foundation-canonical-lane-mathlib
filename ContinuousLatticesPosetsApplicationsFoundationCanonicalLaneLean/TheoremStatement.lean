import continuousLatticesPosetsApplicationsFoundationCanonicalLaneLean.FinalTheorem
...
Continuous Lattices endgame closure. The endgame closes over its admitted class and carries the
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedContinuousLatticeClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_continuous_lattice_endgame A
